...
| `status` | `enum` | yes | {"enum": ["OPEN", "COMPLETE", "FAILED"]} |
...
| `directness` | `enum` | yes | {"enum": ["RAW", "DERIVED"]} |
...
| Field | Type | Required | Constraints / semantics |
|---|---|---|---|
| `schema_version` | `string` | yes | {"const": "4.0.0"} |
...
| `response_artifact_id` | `string` | yes | {"pattern": "^[A-Za-z0-9][A-Za-z0-9_.:@/\\-]*$"} |
